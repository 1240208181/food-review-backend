/*
 ...
 Source Server         : 124.223.11.78
 Source Server Type    : MySQL
 Source Server Version : 50740
 Source Host           : 124.223.11.78:3306
 Source Schema         : hmdp
...
INSERT INTO `tb_blog` VALUES (6, 10, 1, '杭州周末好去处｜💰50就可以骑马啦🐎', '/imgs/blogs/blog1.jpg', '杭州周末好去处｜💰50就可以骑马啦🐎', 1, 0, '2022-01-11 16:05:47', '2023-04-06 15:33:57');
...
INSERT INTO `tb_blog` VALUES (8, 1, 2, '123123', '', '123123', 0, NULL, '2023-04-06 15:37:39', '2023-04-06 15:37:56');
INSERT INTO `tb_blog` VALUES (9, 1, 1010, '123123', '', '123123', 0, NULL, '2023-04-06 15:38:47', '2023-04-06 15:38:47');
...
-- ----------------------------
INSERT INTO `tb_follow` VALUES (1, 1010, 2, '2023-04-06 15:34:38');
...
CREATE TABLE `tb_seckill_voucher`  (
  ...
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `begin_time` timestamp(0) NOT NULL COMMENT '生效时间',
  `end_time` timestamp(0) NOT NULL COMMENT '失效时间',
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
...
-- ----------------------------
INSERT INTO `tb_seckill_voucher` VALUES (1, 100, '2022-01-04 09:42:39', '2023-04-06 15:30:28', '2024-04-06 15:30:33', '2023-04-06 15:30:38');
...
INSERT INTO `tb_user` VALUES (1010, '18106727891', '', 'user_n295lb6om3', '', '2023-04-06 15:20:32', '2023-04-06 15:20:32');
...
-- ----------------------------
INSERT INTO `tb_voucher` VALUES (1, 2, '50元代金券', '周一至周日均可使用', '全场通用\\n无需预约\\n可无限叠加\\不兑现、不找零\\n仅限堂食', 4750, 5000, 0, 1, '2022-01-04 09:42:39', '2023-04-06 15:31:51');
